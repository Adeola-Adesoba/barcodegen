...
def gen_mbc(barcode):
    home = os.path.join(os.getcwd(), "moviebarcode")
    ...
    # args["yturl"] = f'https://www.youtube.com/watch?v={barcode}'
    args["yturl"] = f'{barcode}'
    ...
    if status == "single":
        ...
        # output_directory = home + "\\static" + "\\" + args["yturl"].split("=")[-1]
        output_directory = r'static/'+ args["yturl"].split("=")[-1]

        print('here2', output_directory)
        if not os.path.exists(output_directory):
            os.mkdir(output_directory,0o666)
        ...
        video_url = get_url(YTURL= args["yturl"].split("=")[-1])
